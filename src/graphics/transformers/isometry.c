...
/*   Updated: 2023/03/28 05:43:16 by olimarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_vect2d tile_size)
{
	...
	screen_pos.y -= point.altitude;
	// screen_pos.x = start_pos.x+ (point.x * tile_size.x);
	// screen_pos.y = start_pos.y+ (point.y * tile_size.y);
	return (screen_pos);
}
